...
export default function NavigationBar() {
  return (
    <nav className="w-20 flex flex-col justify-between h-[calc(100vh-5rem)] bg-secondary text-secondary_foreground dark:bg-dark_accent dark:text-dark_foreground">
